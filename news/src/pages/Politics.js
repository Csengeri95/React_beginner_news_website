...
export default function Politics(props) {
    ...
    const pageCount = Math.ceil(list.filter(a => a.category === "political").length / articlesPerPage);
        ...
        .map(map => {
            ...
            return (
                <div
                    ...
                    onClick={() => navigate('/political/' + map.slug)}
                >
    ...
    return (
        <div className="politics">
            ...
            <Helmet>
                <meta name="description" content="A legfontosabb külföldi és hazai politikai hírek - folyamatosan bővülő, naprakész hírfolyam a nagyvilág történéseiből" />
                <title>News.hu - Politikai rovat </title>
                <meta property="og:title" content="News.hu - Politikai rovat " />
                <meta property="og:description" content="A legfontosabb külföldi és hazai politikai hírek - folyamatosan bővülő, naprakész hírfolyam a nagyvilág történéseiből" />
                <meta property="og:image" content="" />
                <meta property="og:site_name" content="news.hu" />
                <meta property="og:url" content="https://news.hu/political" />
